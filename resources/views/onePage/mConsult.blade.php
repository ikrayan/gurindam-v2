            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="about-title text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                        ...
                        <h3 class="title"><span>Our 10 years working experience to </span> take care of your
                            business goal.</h3>
                    </div>
                </div>
            </div> <!-- row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="about-image mt-60 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="{{ asset('onepage/assets/images/about.png') }}" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="our-services-tab pt-30">
                        <ul class="nav justify-content-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s"
                            ...
                            <li class="nav-item">
                                <a class="active" id="business-tab" data-toggle="tab" href="#business"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="our-services-image mt-50">
                                            <img src="{{ asset('onepage/assets/images/our-service-1.jpg') }}"
                                                alt="service">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="our-services-content mt-45">
                                            ...
                                            <p class="text">Lorem ipsum dolor sit amet, consectetur
                                                adipiscing elit. Nam nec est arcu. Maecenas semper tortor. <br> <br> In
                                                elementum in risus sed commodo. Phasellus nisi ligula, luctus at tempor
                                                vitae, placerat at ante. Cras sed consequat justo. Curabitur laoreet eu
                                                est vel convallis. </p>
                ...
                <div class="row no-gutters justify-content-center">
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service d-flex">
                            ...
                            <div class="service-content media-body">
                                ...
                                <p class="text">Lorem Ipsum is simply dummy tex of the printing and
                    ...
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service service-border d-flex">
                            <div class="service-icon">
                                <img src="{{ asset('onepage/assets/images/service-2.png') }}" alt="Icon">
                            </div>
                            <div class="service-content media-body">
        ...
        <div class="container">
            ...
            <div class="row grid">
                <div class="col-lg-4 col-sm-6 grid-item apps creative laptop">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('onepage/assets/images/protfolio-1.jpg') }}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('onepage/assets/images/protfolio-1.jpg') }}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('onepage/assets/images/protfolio-2.jpg') }}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('onepage/assets/images/protfolio-2.jpg') }}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps branding product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('onepage/assets/images/protfolio-3.jpg') }}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('onepage/assets/images/protfolio-3.jpg') }}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('onepage/assets/images/protfolio-5.jpg') }}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('onepage/assets/images/protfolio-5.jpg') }}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('onepage/assets/images/protfolio-4.jpg') }}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('onepage/assets/images/protfolio-4.jpg') }}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('onepage/assets/images/protfolio-6.jpg') }}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('onepage/assets/images/protfolio-6.jpg') }}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-xl-5 col-lg-6">
                    <div class="testimonial-left-content mt-45 wow fadeIn" data-wow-duration="1s"
                        data-wow-delay="0.3s">
                        ...
                        <p class="text">Duis et metus et massa tempus lacinia. Class aptent taciti sociosqu
                            ad litora torquent per conubia nostra, per inceptos himenaeos. Maecenas ultricies, orci
                            molestie blandit interdum. <br> <br> ipsum ante pellentesque nisl, eget mollis turpis quam
                            nec eros. ultricies, orci molestie blandit interdum.</p>
                        ...
                        <div class="testimonial-content-wrapper testimonial-active">
                            <div class="single-testimonial">
                                <div class="testimonial-text">
                                    <p class="text">“Praesent scelerisque, odio eu fermentum malesuada, nisi
                                        arcu volutpat nisl, sit amet convallis nunc turp.”</p>
                                </div>
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="{{ asset('onepage/assets/images/author-1.jpg') }}"
                                                alt="author">
                                        </div>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="{{ asset('onepage/assets/images/author-2.jpg') }}"
                                                alt="author">
                                        </div>
                                        <div class="author-name media-body">
                                            <h5 class="name">John Doe</h5>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="{{ asset('onepage/assets/images/author-3.jpg') }}"
                                                alt="author">
                                        </div>
                                        <div class="author-name media-body">
                                            <h5 class="name">John Doe</h5>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.4s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="{{ asset('onepage/assets/images/news-1.jpg') }}"
                                    alt="news"></a>
                        </div>
                        <div class="blog-content">
                            <h4 class="blog-title"><a href="blog-details.html">Nulla eget urna at tortor turpi
                                    feugiat tristique in sit.</a></h4>
                            <div class="blog-author d-flex align-items-center">
                                <div class="author-image">
                                    <img src="{{ asset('onepage/assets/images/author-1.jpg') }}" alt="author">
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.7s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="{{ asset('onepage/assets/images/news-2.jpg') }}"
                                    alt="news"></a>
                        </div>
                        <div class="blog-content">
                            <h4 class="blog-title"><a href="blog-details.html">Nulla eget urna at tortor turpi
                            ...
                            <div class="blog-author d-flex align-items-center">
                                <div class="author-image">
                                    <img src="{{ asset('onepage/assets/images/author-2.jpg') }}" alt="author">
                                </div>
                                <div class="author-content media-body">
                                    <h6 class="sub-title">Posted by</h6>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="1s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="{{ asset('onepage/assets/images/news-3.jpg') }}"
                                    alt="news"></a>
                        </div>
                        <div class="blog-content">
                            <h4 class="blog-title"><a href="blog-details.html">Nulla eget urna at tortor turpi
                            ...
                            <div class="blog-author d-flex align-items-center">
                                <div class="author-image">
                                    <img src="{{ asset('onepage/assets/images/author-3.jpg') }}" alt="author">
                                </div>
                                <div class="author-content media-body">
                                    <h6 class="sub-title">Posted by</h6>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact-wrapper-form pt-115  wow fadeInUpBig" data-wow-duration="1s"
                        ...
                        <form id="contact-form" action="{{ asset('onepage/assets/contact.php') }}" method="post">
                            <div class="row">
                                <div class="col-md-6">
